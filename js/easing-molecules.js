...
;(function ($, undefined) {
    var $e = $.easing,
        ease = 'ease',
        re = (window.Raphael ? Raphael.easing_formulas : {})
    ...
    function build(name, easeInFunc, inOutTweak) {
        ...
        $e[ease + 'In' + name] = re[ease + 'In' + name] = basicFunc;
        $e[ease + 'Out' + name] = re[ease + 'Out' + name] = reverse(basicFunc);
        $e[ease + 'InOut' + name] = re[ease + 'InOut' + name] = reflect(inOutFunc);
    }
